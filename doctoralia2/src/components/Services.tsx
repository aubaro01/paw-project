...
export default function Services() {
  const services = [
    { title: "Marque consultas", description: "Agende consultas com médicos de forma rápida e fácil.", icon: Calendar },
    {
      title: "Consultas online",
      description: "Realize consultas por videochamada com médicos qualificados.",
      icon: Video,
    },
    { title: "Faça perguntas", description: "Tire suas dúvidas com profissionais de saúde.", icon: MessageSquare },
  ]
